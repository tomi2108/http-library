 ...
 *                 a la lista, por lo que no debe ser liberado por fuera de
 * ésta.
 ...
 * }
 * list_add_sorted(people, person_create("Neymar Jr.", 29), _has_age_less_than);
 * // 0xdef0
 *
 * => people = [0x1234, 0xdef0, 0x5678, 0x9abc]
 * @endcode
 ...
 * @return Los elementos de la lista retornada seguirán perteneciendo a la lista
 * original.
 *
 * Ejemplo de uso:
 * @code
 ...
 *        recibida.
 * @return Los elementos de la lista retornada seguirán perteneciendo a las
 * listas originales.
 *
 * Ejemplo de uso:
 * @code
 ...
 * @param element: El elemento a agregar. Este elemento pasará a pertenecer
 *        a la lista, por lo que no debe ser liberado por fuera de ésta.
 * @return El valor ubicado en la posición index antes de ser reemplazado, o
 * NULL en caso de no encontrar ningún valor. Dejará de pertenecer a la lista,
 ...
 *         people, _has_age_more_than_30, person_create("Kylian Mbappé", 22));
 * // 0xdef0
 *
 * => replaced = 0x1234
 ...
 *        people, 1, person_create("Kylian Mbappé", 22), person_destroy); //
 * 0xdef0
 *
 * => people = [0x1234, 0xdef0, 0x9abc]
 * @endcode
 */
void list_replace_and_destroy_element(t_list *self, int index, void *element,
                                      void (*element_destroyer)(void *));
...
void list_remove_and_destroy_all_by_condition(
    t_list *self, bool (*condition)(void *), void (*element_destroyer)(void *));
 ...
 *     // Modificar la lista con list_iterator_add(), list_iterator_replace() o
