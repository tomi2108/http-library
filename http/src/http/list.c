...
static void list_iterator_add_element(t_list_iterator *iterator,
                                      t_link_element *element);
static void list_iterator_add_element_sorted(t_list_iterator *iterator,
                                             t_link_element *element,
                                             bool (*comparator)(void *,
                                                                void *));
...
static void list_iterator_advance_to_index(t_list_iterator *iterator,
                                           int index);
static bool list_iterator_advance_to_condition(t_list_iterator *iterator,
                                               bool (*condition)(void *));
...
static void *list_iterator_fold(t_list_iterator *iterator, void *seed,
...
void *list_replace_by_condition(t_list *self, bool (*condition)(void *),
                                void *element) {
  t_list_iterator self_iterator = list_iterator_init(self);
...
void list_replace_and_destroy_element(t_list *self, int index, void *data,
...
void list_remove_and_destroy_all_by_condition(
    t_list *self, bool (*condition)(void *),
    void (*element_destroyer)(void *)) {
  t_list_iterator self_iterator = list_iterator_init(self);
  while (list_iterator_has_next(&self_iterator)) {
    void *data = list_iterator_next(&self_iterator);
...
int list_size(t_list *list) { return list->elements_count; }

bool list_is_empty(t_list *list) { return list_size(list) == 0; }
...
int list_add_sorted(t_list *self, void *data,
                    bool (*comparator)(void *, void *)) {
  t_list_iterator self_iterator = list_iterator_init(self);
  list_iterator_add_element_sorted(&self_iterator, list_create_element(data),
                                   comparator);
...
void *list_fold1(t_list *self, void *(*operation)(void *, void *)) {
  t_list_iterator self_iterator = list_iterator_init(self);
  return list_iterator_fold(&self_iterator, list_iterator_next(&self_iterator),
                            operation);
}
...
int list_iterator_index(t_list_iterator *iterator) { return iterator->index; }
...
void list_iterator_destroy(t_list_iterator *iterator) { free(iterator); }
...
static void list_destroy_element(t_link_element *element) { free(element); }

static t_list_iterator list_iterator_init(t_list *list) {
  return (t_list_iterator){
      .list = list, .actual = NULL, .next = &list->head, .index = -1};
}
